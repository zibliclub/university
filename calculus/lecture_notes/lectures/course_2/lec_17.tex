\lesson{17}{от 19 нояб 2023 8:47}{Продолжение}
...
\begin{definition}[Непересекающиеся и попарно непересекающиеся множества]
...
\begin{definition}[Разбиение множества]
...
\begin{definition}[Клеточное множество]
...
\begin{definition}[Измеримое по Жордану множество]
...
\begin{definition}[Мера для измеримого по Жордану множества]
